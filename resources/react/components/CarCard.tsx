...
export default function CarCard({
  ...
  return (
    ...
    >
      {/* Newly Arrived Badge */}
      <div
        className="absolute top-3 start-3 z-10 rounded-full px-3 py-1 text-[11px] font-black"
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex-1 text-end">
            ...
            <h3 className="truncate text-[16px] font-black leading-tight text-[#16254F]" title={`${brand} ${name}`}>
              {name}
            </h3>
          </div>
        </div>
        ...
        <div className="mt-4 border-t border-[#E7E9EF] pt-3">
          <div className="flex items-end justify-between">
            ...
            <div className="text-start">
              <p className="mb-1 text-[10px] font-normal text-[#667085]">{t("carCard.monthlyPayment")}</p>
            ...
            <div className="text-end">
              <p className="mb-1 text-[10px] font-normal text-[#667085]">{t("carCard.cashPrice")}</p>
