            ...
            <form id="globalDeliveredForm" method="POST">
                ...
                <div class="modal-body px-4 py-3">
                    ...
                    <div class="row g-3">
                        ...
                        {{-- 5. الدفعة الأولى --}}
                        <div class="col-6">
                            <label class="form-label fw-bold small text-muted">{{ __('الدفعة الأولى') }}</label>
                            <div class="input-group input-group-sm">
                        ...
                        {{-- 6. القسط الشهري --}}
                        <div class="col-6">
                            <label class="form-label fw-bold small text-muted">{{ __('القسط الشهري') }}</label>
                            <div class="input-group input-group-sm">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="note" id="deliveredNote" class="form-control bg-light border-0 shadow-none" rows="2" style="border-radius:10px; font-size:13px;" placeholder="{{ __('ملاحظات حول استلام العميل للسيارة...') }}"></textarea>
                    </div>
                </div>
                <div class="modal-footer border-0 px-4 pb-4 pt-0 gap-2">
                    <button type="button" class="btn btn-light py-2 px-3 fw-bold rounded-3 flex-fill" data-bs-dismiss="modal">{{ __('إلغاء') }}</button>
