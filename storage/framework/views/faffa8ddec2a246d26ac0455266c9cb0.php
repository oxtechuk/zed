...
<head>
    ...
    ?>
    <title><?php echo e(__('تسجيل دخول المديرين | ') . $siteNameText); ?></title>
    <?php if($siteFavicon): ?>
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="image-panel">
            <div class="image-panel-content" dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>">
        ...
        <div class="form-panel" dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>">
            ...
            <div class="form-content-wrapper">
                <div class="logo-section">
                    ...
                    ?>
                    <?php if($siteLogoSetting): ?>
                        <img src="<?php echo e(asset('storage/' . $siteLogoSetting)); ?>" alt="<?php echo e($siteNameText); ?>" style="max-height: 75px; width: auto; filter: drop-shadow(0 4px 10px rgba(41, 155, 224, 0.15));">
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/logo_without_bg.png')); ?>" alt="<?php echo e($siteNameText); ?>" style="max-height: 75px; width: auto; filter: drop-shadow(0 4px 10px rgba(41, 155, 224, 0.15));">
                    <?php endif; ?>
                ...
                <form action="<?php echo e(route('crm.login.post')); ?>" method="POST" id="loginForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        <label class="form-label"><?php echo e(__('كلمة المرور')); ?></label>
                        <div class="input-wrapper">
                    ...
                    <div class="remember-row">
                        ...
                        <label for="remember"><?php echo e(__('تذكرني')); ?></label>
                    </div>

                    <button type="submit" class="btn-login" id="loginBtn">
                        <span class="btn-icon"><i class="bi bi-arrow-<?php echo e(app()->getLocale() == 'ar' ? 'left' : 'right'); ?>-short" style="font-size: 24px;"></i></span>
                        <span class="btn-text"><?php echo e(__('تسجيل الدخول')); ?></span>
            ...
            <div class="footer-text">
                &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(route('store.home')); ?>"><?php echo e($siteNameText); ?></a> Dashboard. All rights reserved.
            </div>
...
</html><?php /**PATH D:\Projects\XO\Zad\resources\views/crm/auth/login.blade.php ENDPATH**/ ?>