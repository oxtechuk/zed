        ...
        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
            <div class="modal-header border-0 pb-0 px-4 pt-4" style="background:#FFF9F0;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="modal-title fw-bold mb-0" id="globalPendingModalLabel"><?php echo e(__('نقل الطلب إلى قيد الانتظار')); ?></h6>
            ...
            <form id="globalPendingForm" method="POST">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" name="pending_reason" id="globalPendingReason" class="form-control bg-light border-0 shadow-none" required style="border-radius:10px; font-size:13px; padding:9px 14px;" placeholder="<?php echo e(__('مثال: العميل خارج المملكة، بانتظار الراتب...')); ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="note" id="globalPendingNote" class="form-control bg-light border-0 shadow-none" rows="3" required style="border-radius:10px; font-size:13px;" placeholder="<?php echo e(__('اكتب هنا تفاصيل إضافية للمتابعة...')); ?>"></textarea>
                    </div>
                </div>
                <div class="modal-footer border-0 px-4 pb-4 pt-0 gap-2">
                    ...
                    <button type="submit" class="btn py-2 px-3 fw-bold rounded-3 flex-fill text-white" style="background:#D97706;"><?php echo e(__('تأكيد ونقل لقيد الانتظار')); ?></button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
            <div class="modal-header border-0 pb-0 px-4 pt-4" style="background:#F0FDF4;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="modal-title fw-bold mb-0 text-success" id="globalDeliveredModalLabel"><?php echo e(__('إتمام تسليم الطلب')); ?></h6>
            ...
            <form id="globalDeliveredForm" method="POST">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="alert alert-success border-0 rounded-3 mb-3 p-2 d-flex align-items-center gap-2" style="font-size:12px;background:#DCFCE7;color:#166534;">
                        ...
                        <span><?php echo e(__('يرجى إدخال البيانات المالية للتسليم ليتم تحويل الطلب إلى قائمة «تم التسليم».')); ?></span>
                    </div>

                    <div class="row g-3">
                        
                        <div class="col-6">
                            <label class="form-label fw-bold small text-muted"><?php echo e(__('سعر شراء السيارة')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-6">
                            <label class="form-label fw-bold small text-muted"><?php echo e(__('سعر تعميد السيارة')); ?> <span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                        ...
                        <div class="col-6">
                            <label class="form-label fw-bold small text-muted"><?php echo e(__('المصروفات')); ?></label>
                            <div class="input-group input-group-sm">
                        ...
                        <div class="col-6">
                            <label class="form-label fw-bold small text-muted"><?php echo e(__('صافي عمولة الشركة')); ?></label>
                            <div class="input-group input-group-sm">
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0 gap-2">
                    <button type="button" class="btn btn-light py-2 px-3 fw-bold rounded-3 flex-fill" data-bs-dismiss="modal"><?php echo e(__('إلغاء')); ?></button>
                    <button type="submit" class="btn btn-success py-2 px-3 fw-bold rounded-3 flex-fill text-white"><?php echo e(__('تأكيد وإتمام التسليم')); ?></button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
            <div class="modal-header border-0 pb-0 px-4 pt-4" style="background:#FEF2F2;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="modal-title fw-bold mb-0 text-danger" id="globalRequestCloseModalLabel"><?php echo e(__('طلب إغلاق الحجز')); ?></h6>
            ...
            <form id="globalRequestCloseForm" method="POST">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="alert alert-warning border-0 rounded-3 text-warning-dark p-2" style="font-size: 12px;background:#FEF3C7;color:#92400E;">
                        ...
                        <?php echo e(__('سيتم إرسال هذا الطلب إلى المشرف للاعتماد والموافقة على الإغلاق.')); ?>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="note" class="form-control bg-light border-0 shadow-none" rows="3" required style="border-radius:10px; font-size:13px;" placeholder="<?php echo e(__('اكتب هنا تبرير الإغلاق أو الملاحظات...')); ?>"></textarea>
                    </div>
                </div>
                <div class="modal-footer border-0 px-4 pb-4 pt-0 gap-2">
                    <button type="button" class="btn btn-light py-2 px-3 fw-bold rounded-3 flex-fill" data-bs-dismiss="modal"><?php echo e(__('إلغاء')); ?></button>
                    <button type="submit" class="btn btn-danger py-2 px-3 fw-bold rounded-3 flex-fill"><?php echo e(__('إرسال الطلب للمشرف')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\zed\resources\views/crm/bookings/partials/status-modals.blade.php ENDPATH**/ ?>