...
<div class="err404-wrap">
    ...
    <div class="err404-inner">
        ...
        <h1 class="error-title">
            <?php echo e(__('عُذراً! هذه الصفحة')); ?> <span><?php echo e(__('غير موجودة')); ?></span>
        </h1>

        <p class="error-subtitle">
            <?php echo e(__('يبدو أن هذه الصفحة انطلقت بسرعة كبيرة ولم نتمكن من اللحاق بها. دعنا نعود إلى الطريق الصحيح.')); ?>

        </p>

        
        <div class="err-btn-group">
            <a href="<?php echo e(route('store.home')); ?>" class="btn-404 btn-404--primary">
                <i class="bi bi-house-door-fill"></i>
                <?php echo e(__('الصفحة الرئيسية')); ?>

            </a>
            <a href="<?php echo e(route('store.cars.index')); ?>" class="btn-404 btn-404--ghost">
                <i class="bi bi-car-front-fill"></i>
                <?php echo e(__('تصفح السيارات')); ?>
        ...
        <div class="quick-links">
            <a href="<?php echo e(url('/offers')); ?>" class="quick-link">
                <i class="bi bi-tag-fill"></i> <?php echo e(__('العروض')); ?>

            </a>
            <a href="<?php echo e(url('/blog')); ?>" class="quick-link">
                <i class="bi bi-journal-text"></i> <?php echo e(__('المقالات')); ?>

            </a>
            <a href="<?php echo e(url('/about')); ?>" class="quick-link">
                <i class="bi bi-info-circle-fill"></i> <?php echo e(__('من نحن')); ?>

            </a>
            <a href="<?php echo e(url('/finance-calculator')); ?>" class="quick-link">
                <i class="bi bi-calculator-fill"></i> <?php echo e(__('الحاسبة')); ?>
...
<?php echo $__env->make('store.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zed\resources\views/errors/404.blade.php ENDPATH**/ ?>