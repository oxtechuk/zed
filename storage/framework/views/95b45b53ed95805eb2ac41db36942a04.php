    ...
    <div class="container-fluid" dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="text-muted mb-0 small"><?php echo e(__('إدارة آراء وتقييمات العملاء المعروضة على الموقع')); ?></p>
            </div>
        ...
        <ul class="nav nav-pills mb-4 gap-2" id="testimonialTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active rounded-pill px-4 fw-bold" id="text-tab" data-bs-toggle="tab" data-bs-target="#text-testimonials" type="button" role="tab" aria-controls="text-testimonials" aria-selected="true">
                    <i class="bi bi-chat-left-text me-1"></i> <?php echo e(__('آراء العملاء كتابة')); ?> (<?php echo e($textTestimonials->count()); ?>)
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link rounded-pill px-4 fw-bold" id="video-tab" data-bs-toggle="tab" data-bs-target="#video-testimonials" type="button" role="tab" aria-controls="video-testimonials" aria-selected="false">
                    <i class="bi bi-play-btn me-1"></i> <?php echo e(__('آراء العملاء فيديوهات ريلز')); ?> (<?php echo e($videoTestimonials->count()); ?>)
                </button>
            </li>
        </ul>
        ...
        <div class="tab-content" id="testimonialTabsContent">
            ...
            <div class="tab-pane fade show active" id="text-testimonials" role="tabpanel" aria-labelledby="text-tab">
                <div class="row g-4">
                    <?php $__empty_1 = true; $__currentLoopData = $textTestimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-12 text-center py-5">
                            <div class="card border-0 shadow-sm rounded-4 p-5">
                                ...
                                <h6 class="fw-bold"><?php echo e(__('لا يوجد توصيات مكتوبة مسجلة حالياً')); ?></h6>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="tab-pane fade" id="video-testimonials" role="tabpanel" aria-labelledby="video-tab">
                <div class="row g-4">
                    <?php $__empty_1 = true; $__currentLoopData = $videoTestimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col-md-6 col-xl-4">
                            <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center mb-3">
                                    ...
                                    <?php if($testimonial->review_video): ?>
                                        <div class="position-relative rounded-3 overflow-hidden bg-dark d-flex align-items-center justify-content-center" style="height: 120px;">
                                            <video src="<?php echo e(asset('storage/' . $testimonial->review_video)); ?>" class="w-100 h-100 object-fit-cover opacity-75" muted></video>
                                            <div class="position-absolute bg-white/20 backdrop-blur-md rounded-circle p-2 text-white">
                                                <i class="bi bi-play-fill fs-4"></i>
                                            </div>
                                        </div>
                                    <?php elseif($testimonial->review_image): ?>
                                        <div class="rounded-3 overflow-hidden" style="height: 120px;">
                                            <img src="<?php echo e(asset('storage/' . $testimonial->review_image)); ?>" class="w-100 h-100 object-fit-cover" alt="Review Image">
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="card-footer bg-light border-0 d-flex gap-2 p-2">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-12 text-center py-5">
                            <div class="card border-0 shadow-sm rounded-4 p-5">
                                ...
                                <h6 class="fw-bold"><?php echo e(__('لا يوجد آراء فيديو ريلز مسجلة حالياً')); ?></h6>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
