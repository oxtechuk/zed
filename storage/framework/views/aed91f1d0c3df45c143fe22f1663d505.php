...
<head>
    ...
    <title><?php echo e(__('ممنوع الدخول')); ?> — Zad Capital</title>
...
<body>
    ...
    <div class="err-wrap">
        ...
        <h1 class="error-title"><?php echo e(__('عذراً! الوصول إلى هذه الصفحة')); ?> <span><?php echo e(__('ممنوع')); ?></span></h1>
        <p class="error-subtitle"><?php echo e(__('ليست لديك الصلاحيات اللازمة للوصول إلى هذه الصفحة. إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع الإدارة.')); ?></p>
        <div class="err-btn-group">
            <a href="<?php echo e(route('store.home')); ?>" class="btn-err btn-err--primary">
...
</html><?php /**PATH D:\Projects\XO\Zad\resources\views/errors/403.blade.php ENDPATH**/ ?>