...
<div class="container-fluid" dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <div class="d-flex gap-3 mb-4 pb-1" style="overflow-x:auto;">
        <a href="<?php echo e(route('crm.bookings.index')); ?>" class="crm-stat-new flex-shrink-0 text-decoration-none" style="min-width:210px;">
            <div class="stat-icon blue"><i class="bi bi-lightning-charge"></i></div>
            <div class="stat-lbl"><?php echo e(__('الطلبات النشطة (Active)')); ?></div>
            <div class="stat-val text-primary"><?php echo e(number_format($stats['open'])); ?></div>
        </a>
        <a href="<?php echo e(route('crm.bookings.pending')); ?>" class="crm-stat-new flex-shrink-0 text-decoration-none" style="min-width:210px;">
            <div class="stat-icon orange"><i class="bi bi-hourglass-split"></i></div>
            <div class="stat-lbl"><?php echo e(__('قيد الانتظار')); ?></div>
            <div class="stat-val text-warning-dark"><?php echo e(number_format($stats['pending'])); ?></div>
        </a>
        <a href="<?php echo e(route('crm.bookings.delivered')); ?>" class="crm-stat-new flex-shrink-0 text-decoration-none" style="min-width:210px;">
            <div class="stat-icon green"><i class="bi bi-check2-circle"></i></div>
            <div class="stat-lbl"><?php echo e(__('تم التسليم (المستلمة)')); ?></div>
            <div class="stat-val text-success"><?php echo e(number_format($stats['completed'])); ?></div>
        </a>
        <a href="<?php echo e(route('crm.bookings.closed')); ?>" class="crm-stat-new flex-shrink-0 text-decoration-none" style="min-width:210px;">
            <div class="stat-icon red"><i class="bi bi-folder-x"></i></div>
            <div class="stat-lbl"><?php echo e(__('الطلبات المغلقة')); ?></div>
            <div class="stat-val text-danger"><?php echo e(number_format($stats['closed'])); ?></div>
        </a>
        <a href="<?php echo e(route('crm.bookings.index')); ?>" class="crm-stat-new flex-shrink-0 text-decoration-none" style="min-width:210px;">
            <div class="stat-icon purple"><i class="bi bi-collection"></i></div>
            <div class="stat-lbl"><?php echo e(__('إجمالي الطلبات')); ?></div>
            <div class="stat-val" style="color:#7C3AED;"><?php echo e(number_format($stats['total'])); ?></div>
        </a>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4" style="border:1px solid var(--crm-border)!important;">
        <div class="card-body p-4">
            <form action="<?php echo e(route('crm.dashboard')); ?>" method="GET" class="d-flex flex-wrap align-items-center gap-2">
                ...
                <?php if($isAdmin && $employees->isNotEmpty()): ?>
