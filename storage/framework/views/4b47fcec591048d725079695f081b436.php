    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-xl-4">
            <div class="crm-stat-new">
                <span class="stat-badge orange"><?php echo e($activeLeadsRatio); ?>%</span>
                <div class="stat-icon green"><i class="bi bi-person-check"></i></div>
                <div class="stat-lbl"><?php echo e(__('العملاء النشطون')); ?></div>
                <div class="stat-val"><?php echo e(number_format($activeLeadsCount)); ?></div>
            </div>
        </div>
        <div class="col-6 col-xl-4">
            <div class="crm-stat-new">
                <span class="stat-badge green"><?php echo e($newLeadsRatio); ?>%</span>
                <div class="stat-icon blue"><i class="bi bi-people"></i></div>
                <div class="stat-lbl"><?php echo e(__('العملاء الجدد')); ?></div>
                <div class="stat-val"><?php echo e(number_format($newLeadsCount)); ?></div>
            </div>
        </div>
        <div class="col-6 col-xl-4">
            <div class="crm-stat-new">
                ...
                <div class="stat-lbl"><?php echo e(__('إجمالي عدد العملاء')); ?></div>
